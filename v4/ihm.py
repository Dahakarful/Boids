...
class Ihm:
    ...
    def drawFish(self, fishAgent):
        self.canvas.create_line(fishAgent.x, fishAgent.y, fishAgent.x - Ihm.AGENT_LENGTH * fishAgent.vx, fishAgent.y - Ihm.AGENT_LENGTH * fishAgent.vy, fill=fishAgent.color)
